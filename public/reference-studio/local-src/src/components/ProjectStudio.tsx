...
export const ProjectStudio: React.FC = () => {
    ...
    const handleAddTodo = () => {
        ...
        setChannelHub({ toDos: [...brain.channelHub.toDos, newTodo] });
        setNewTodoInput('');
    };
    ...
    const handleAddGoal = () => {
        ...
        setChannelHub({ goals: [...brain.channelHub.goals, newGoal] });
        setNewGoalInput('');
    };
                    ...
                    <div className="flex-1 bg-white">
                        {viewContext === 'channel' ? (
                            ...
                            <div className="p-10 animate-fade-in flex flex-col gap-10">
                                <div className="bg-[#ff3399] border-[5px] border-black rounded-[40px] shadow-[8px_8px_0px_0px_black] p-6 flex justify-between items-center">
                                    <div className="flex items-center gap-6">
                                        <div className="bg-white border-[4px] border-black rounded-2xl p-3">
                                            <Target size={32} />
                                        </div>
                                        <h2 className="text-4xl font-[1000] uppercase tracking-tighter">CHANNEL MANAGEMENT</h2>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-10">
                                    ...
                                    >
                                        <div className="space-y-6">
                                            ...
                                            <div className="space-y-3 max-h-[400px] overflow-y-auto custom-scrollbar pr-2">
                                                {brain.channelHub.toDos.map(todo => (
                                                ...
                                                {brain.channelHub.toDos.length === 0 && (
                                    ...
                                    >
                                        <div className="space-y-6">
                                            ...
                                            <div className="space-y-3 max-h-[400px] overflow-y-auto custom-scrollbar pr-2">
                                                {brain.channelHub.goals.map(goal => (
                                                ...
                                                {brain.channelHub.goals.length === 0 && (
