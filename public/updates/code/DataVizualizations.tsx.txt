...
export default function DataVisualizations() {
  ...
  const footprintSpec = getChartSpecById("global-footprint");
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8 bg-[#f4f4f0] min-h-screen">
      ...
      <ChartContainer title={valueMatrixSpec.title} headerColor={valueMatrixSpec.headerColorClass}>
        <CustomScatterPlot 
          data={bubblePoints} 
          bubbleMode={true}
      ...
      <ChartContainer title={triggerSpec.title} headerColor={triggerSpec.headerColorClass}>
        <CustomScatterPlot 
          data={scatterPoints}
          color={CHART_THEME.palette.magenta}
          xLabel="Click-Through Rate (%)"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <ChartContainer title={deviceSpec.title} headerColor={deviceSpec.headerColorClass}>
          <CustomBarChart 
            data={deviceData} 
            colorMap={[CHART_THEME.palette.magenta, CHART_THEME.palette.cyan, CHART_THEME.palette.lime]} 
          />
        </ChartContainer>

        {/* CHART 7: GLOBAL FOOTPRINT */}
        <ChartContainer title={footprintSpec.title} headerColor={footprintSpec.headerColorClass}>
          <CustomBarChart 
            data={geoData} 
            colorMap={[CHART_THEME.palette.cyan, CHART_THEME.palette.lime, CHART_THEME.palette.yellow, CHART_THEME.palette.orange, CHART_THEME.palette.magenta]} 
          />
        </ChartContainer>
      </div>
