<!-- GENERATED by scripts/herald-sync.mjs from agent/skills/viewtube-widget-dashboard/references/architecture-baseline.md — do not edit; run `node scripts/herald-sync.mjs` -->
