<!-- GENERATED by scripts/herald-sync.mjs from agent/skills/viewtube-widget-dashboard/references/widget-build-contract.md — do not edit; run `node scripts/herald-sync.mjs` -->
