...
export interface RenderJobRequest{schemaVersion:'RemotionRenderJobV1';kind:'remotionRender';sourceEditor:'VT_E1';renderMode?:'remotion-mp4'|string;outputFormat:RenderOutputFormat;project:VtE1Project;projectId?:string;compositionId?:string;compositionMeta:RenderCompositionMeta;previewParity?:unknown}
export interface RenderJob{jobId:string;projectId?:string;compositionId?:string;kind?:string;renderMode?:string;status:RenderJobStatus;outputFormat?:string;progress:number;downloadUrl?:string|null;failureReason?:string|null;warnings?:string[];diagnostics?:Record<string,unknown>;createdAt?:string;updatedAt?:string;startedAt?:string|null;completedAt?:string|null}
