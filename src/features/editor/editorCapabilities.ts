...
export const EDITOR_CAPABILITIES: EditorCapability[] = [
  ...
  {id:'transform.position',category:'edit',label:'Position',status:'planned',selection:['video','overlay','caption']},
  {id:'transform.scale',category:'edit',label:'Scale',status:'planned',selection:['video','overlay','caption']},
  {id:'transform.rotate',category:'edit',label:'Rotate',status:'planned',selection:['video','overlay','caption']},
  {id:'transform.crop',category:'edit',label:'Crop',status:'planned',selection:['video']},
  ...
  {id:'audio.volume',category:'audio',label:'Volume',status:'planned',selection:['audio','track']},
