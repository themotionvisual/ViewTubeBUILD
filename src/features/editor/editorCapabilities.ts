...
export const EDITOR_CAPABILITIES: EditorCapability[] = [
  ...
  {id:'effects.color',category:'effects',label:'Color',status:'available',selection:['video','overlay'],action:'updateLayerPayload'},
  {id:'effects.blur',category:'effects',label:'Blur',status:'available',selection:['video','overlay'],action:'updateLayerPayload'},
