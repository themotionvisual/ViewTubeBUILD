...
describe("VT-SYNC data visual module registry", () => {
 ...
 it("keeps unified visual controller and icon metadata in the registry", () => {
  ...
  expect(visualStyleSource).toContain('"vt2-multi-metric-timeline": { iconKey: "!!!A:B-TESTING" }')
  ...
  expect(visualStyleSource).toContain('"engagement-lines": { iconKey: "!!!A:B-TESTING" }')
