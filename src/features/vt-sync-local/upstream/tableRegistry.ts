...
col("caption", "Captions", "Format"),
  ...
  col("videosAddedToPlaylists", "Added to Playlists", "Playlist Actions", "number"),
  col("videosRemovedFromPlaylists", "Removed from Playlists", "Playlist Actions", "number"),
  ...
  col("cardsShown", "Cards Shown", "Cards", "number"),
  col("cardClicks", "Card Clicks", "Cards", "number"),
  col("clicksPerCardShown", "Card Click %", "Cards", "percent"),
  col("cardTeasersShown", "Teasers Shown", "Teasers", "number"),
  col("cardTeaserClicks", "Teaser Clicks", "Teasers", "number"),
  col("teaserClicksPerCardTeaserShown", "Teaser Click %", "Teasers", "percent"),
