...
const W=1920,H=1080;
const lower=(id:string,name:string,primary:string,secondary:string,tags:string[]):TemplateDefinition=>({id,name,category:'graphic',tags:['youtube','lower-third',...tags],aspectRatio:'responsive',width:W,height:H,durationFrames:120,customizable:true,responsive:true,elements:[
{id:'plate',type:'svg',name:'Plate',x:110,y:785,width:980,height:170,svg:'<svg viewBox="0 0 980 170"><rect x="4" y="4" width="972" height="162" rx="26" fill="currentColor" stroke="#171717" stroke-width="8"/></svg>',fillToken:'colors.background',strokeToken:'colors.border',editable:true,animation:{preset:'slide',durationFrames:18,direction:'left'}},
{id:'primary',type:'text',name:'Primary',x:160,y:820,width:860,height:58,text:primary,fontSize:46,fontSizeToken:'sizing.subtitleSize',fontFamilyToken:'typography.headingFamily',fontWeight:999,fillToken:'colors.foreground',editable:true,animation:{preset:'stagger-words',durationFrames:18}},
{id:'secondary',type:'text',name:'Secondary',x:160,y:880,width:850,height:42,text:secondary,fontSize:26,fontSizeToken:'sizing.bodySize',fontFamilyToken:'typography.bodyFamily',fontWeight:850,fillToken:'colors.accent',editable:true,animation:{preset:'fade',durationFrames:14,delayFrames:6}}
...
const cta=(id:string,name:string,headline:string,sub:string,tags:string[],icon:string):TemplateDefinition=>({id,name,category:'engagement',tags:['youtube','engagement','overlay',...tags],aspectRatio:'responsive',width:W,height:H,durationFrames:75,customizable:true,responsive:true,elements:[
{id:'icon',type:'text',name:'Icon',x:145,y:760,width:120,height:120,text:icon,fontSize:82,fontSizeToken:'sizing.iconSize',fontFamilyToken:'typography.displayFamily',fontWeight:999,fillToken:'colors.accent',editable:true,animation:{preset:'pop',durationFrames:16}},
{id:'headline',type:'text',name:'Headline',x:285,y:770,width:1000,height:70,text:headline,fontSize:52,fontSizeToken:'sizing.subtitleSize',fontFamilyToken:'typography.headingFamily',fontWeight:999,fillToken:'colors.foreground',editable:true,animation:{preset:'slide',durationFrames:18,direction:'right'}},
{id:'sub',type:'text',name:'Subline',x:288,y:837,width:1040,height:46,text:sub,fontSize:26,fontSizeToken:'sizing.bodySize',fontFamilyToken:'typography.bodyFamily',fontWeight:800,fillToken:'colors.secondary',editable:true,animation:{preset:'fade',durationFrames:15,delayFrames:7}}
...
{id:'headline',type:'text',name:'Headline',x:130,y:100,width:1660,height:120,text:headline,fontSize:86,fontSizeToken:'sizing.titleSize',fontFamilyToken:'typography.displayFamily',fontWeight:999,fillToken:'colors.foreground',editable:true,animation:{preset:'stagger-words',durationFrames:22}},
{id:'sub',type:'text',name:'Subline',x:134,y:225,width:1500,height:60,text:sub,fontSize:32,fontSizeToken:'sizing.subtitleSize',fontFamilyToken:'typography.bodyFamily',fontWeight:850,fillToken:'colors.accent',editable:true,animation:{preset:'fade',durationFrames:16,delayFrames:6}}
];
for(let i=0;i<slots;i++){elements.push({id:`slot-${i+1}`,type:'svg',name:`YouTube End Screen Slot ${i+1}`,x:130+i*(slots===1?0:560),y:360,width:slots===1?1050:500,height:330,svg:'<svg viewBox="0 0 500 330"><rect x="4" y="4" width="492" height="322" rx="24" fill="none" stroke="currentColor" stroke-width="8" stroke-dasharray="22 14"/></svg>',strokeToken:'colors.border',editable:true,animation:{preset:'scale',durationFrames:16,delayFrames:i*5}})}
elements.push({id:'subscribe-slot',type:'svg',name:'Subscribe Slot',x:1330,y:720,width:320,height:130,svg:'<svg viewBox="0 0 320 130"><rect x="4" y="4" width="312" height="122" rx="61" fill="none" stroke="currentColor" stroke-width="8" stroke-dasharray="18 12"/></svg>',strokeToken:'colors.accent',editable:true,animation:{preset:'pop',durationFrames:16,delayFrames:12}});
return{id,name,category:'engagement',tags:['youtube','watch-next','end-screen',...tags],aspectRatio:'responsive',width:W,height:H,durationFrames:450,customizable:true,responsive:true,elements,responsiveLayouts:{portrait:{canvas:{aspectRatio:'9:16',safeArea:100},spacing:{padding:100,gap:32,insetX:100,insetY:170}},square:{canvas:{aspectRatio:'1:1',safeArea:74}}}}};
