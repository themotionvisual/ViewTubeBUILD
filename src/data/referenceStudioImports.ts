...
export const referenceStudioImportPacks: ReferenceStudioImportPack[] = [
  {
    ...
    addedOn: "2026-03-27",
    source: "/reference-studio/imports/b_n4S0QgDB6zU-1774607113118.zip",
    totalFiles: 87,
    uiComponentFiles: 57,
    variantFiles: 4,
    path: "/reference-studio/imports/b_n4S0QgDB6zU-1774607113118/app/page.tsx",
    highlights: [
...
export const toolboxBaselineCoverage: ToolboxCoverageItem[] = [
  { tool: "Overview Dashboard", baselineComponent: "Realtime Views panel + metric cards", status: "integrated" },
