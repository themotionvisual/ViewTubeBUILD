...
export const GUIDE_FEATURES: readonly GuideFeatureDefinition[] = Object.freeze([
 ...
 { id:"script-architect", title:"Script Architect", domain:"create", lifecycle:"live", routes:["/script-architect","/studio#script-architect"], summary:"Assembles a timed script from a brief, chapters, references and the creator's own locked script pieces, plus visuals and priming shorts.", sourceOfTruth:"ScriptArchitect" },
 { id:"packaging-lab-pro", title:"Packaging Lab Pro", domain:"publish", lifecycle:"live", routes:["/packaging-lab-pro"], summary:"Shapes title systems, thumbnail direction, description framing and packaging experiments into one saved packaging packet with ranking and provenance.", sourceOfTruth:"PackagingLabPro" },
