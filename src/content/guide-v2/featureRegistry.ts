...
export const GUIDE_FEATURES: readonly GuideFeatureDefinition[] = Object.freeze([
 ...
 { id:"feature-access", title:"Feature Access", domain:"start", lifecycle:"beta", routes:["/settings?panel=access"], summary:"Explains plan, channel, capability, data, credit, rollout, and approval requirements without hiding the current tools.", sourceOfTruth:"featureGating.ts" },
