...
export const GUIDE_FEATURES: readonly GuideFeatureDefinition[] = Object.freeze([
 ...
 { id:"script-architect", title:"Script Architect", domain:"create", lifecycle:"live", routes:["/script-architect","/studio#script-architect"], summary:"Turns a chosen angle into ordered beats, proof placement, transitions and a storyboard handoff packet.", sourceOfTruth:"ScriptArchitect" },
