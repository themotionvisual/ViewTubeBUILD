...
export const GUIDE_FEATURES: readonly GuideFeatureDefinition[] = Object.freeze([
 ...
 { id:"projects", title:"Projects", domain:"create", lifecycle:"live", routes:["/projects"], summary:"Project calendar, planning and creator workflow state.", sourceOfTruth:"ProjectCalendarPage" },
 ...
 { id:"account", title:"Account & Channel Connection", domain:"start", lifecycle:"beta", routes:["/account","/account/connect","/settings"], summary:"ViewTube account, Google authorization and connected YouTube channel.", sourceOfTruth:"Simple Auth V1; legacy account runtime remains during cutover" },
