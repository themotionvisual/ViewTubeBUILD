...
export const CONTEXT_HELP: readonly ContextHelpEntry[] = Object.freeze([
 { id:"dashboard", title:"Dashboard help", route:"/", guideAnchor:"guide-start", summary:"Understand the home dashboard and where to go next." },
 { id:"analytics", title:"Analytics help", route:"/local-analytics", guideAnchor:"guide-analytics", summary:"Sync, inspect and interpret canonical YouTube datasets." },
