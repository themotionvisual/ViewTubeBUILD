...
export const ProjectStudioProjectFields: React.FC<{
  ...
  <SubToolboxStack density="comfortable">
    <SubToolboxSection label="Project identity"><SubToolboxGrid minItemWidth="wide" density="dense">
      ...
      <SubToolboxSelect value={status} onChange={(event) => onChange("status", event.target.value)} aria-label="Project status"><option value="ideation">Ideation</option><option value="planning">Planning</option><option value="production">Production</option><option value="editing">Editing</option><option value="ready">Ready</option><option value="published">Published</option></SubToolboxSelect>
