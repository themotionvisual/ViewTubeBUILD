...
export const SUBTOOLBOX_MIGRATION_WAVES = [
  { id: 1, surfaces: ["ThumbnailStudio", "CommunityPostGenerator"] },
  { id: 2, surfaces: ["VideoManager", "VideoPublisher"] },
  { id: 3, surfaces: ["ScriptArchitect", "ActionableTactics", "MediaAnalyzer"] },
  { id: 4, surfaces: ["ProjectStudio", "StoryboardStudio"] },
  { id: 5, surfaces: ["SubToolboxChartModule", "SystemStatisticsSubToolbox", "remaining-consumers"] },
] as const
