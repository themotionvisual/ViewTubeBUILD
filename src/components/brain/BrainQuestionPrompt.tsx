...
export const BrainQuestionPrompt: React.FC<{
 ...
 return (
  <section className="overflow-hidden rounded-[10px] border-[2px] border-black bg-white">
   <div className="border-b-[2px] border-black bg-[#FFDA47] px-3 py-2">
   ...
   <div className="grid gap-2.5 p-3">
     ...
     <div className="flex flex-wrap gap-1.5">
      {options.map((option) => (
       <button
        ...
        className="rounded-[8px] border-[2px] border-black bg-white px-2.5 py-1 text-[10px] font-black uppercase tracking-[0.06em] hover:bg-[#3FEE56]"
       >
        {option}
       </button>
      ))}
    ...
    <div className="flex gap-2">
     <input
      ...
      className="min-w-0 flex-1 rounded-[8px] border-[2px] border-black bg-white px-2.5 py-1.5 text-xs font-bold outline-none focus:bg-[#FFDA47]/25"
     />
     <button
      type="button"
      ...
      className="inline-flex shrink-0 items-center gap-1 rounded-[8px] border-[2px] border-black bg-[#3FEE56] px-2.5 py-1.5 text-[10px] font-black uppercase disabled:opacity-40"
     >
      Save
      <ArrowRight size={12} />
     </button>
