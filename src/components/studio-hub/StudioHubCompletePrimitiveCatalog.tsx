...
import {
  SubToolboxFileTarget, SubToolboxInput, SubToolboxTextArea, SubToolboxTooltip,
...
const GenericControl: React.FC<{ name: string; level: Level; index: number; paletteIndex: number }> = ({ name, level, index, paletteIndex }) => {
  ...
  if (name === "Tooltip") return <SubToolboxTooltip level={level} forceOpen content="TOOLTIP" style={style} />
