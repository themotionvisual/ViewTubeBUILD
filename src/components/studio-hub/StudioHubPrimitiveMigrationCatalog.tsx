...
const CATALOG_PREVIEW_GEOMETRY: Partial<Record<(typeof STUDIO_HUB_MIGRATED_FAMILIES)[number], CatalogPreviewGeometry>> = {
...
const getCatalogPreviewGeometry = (name: (typeof STUDIO_HUB_MIGRATED_FAMILIES)[number]): CatalogPreviewGeometry =>
