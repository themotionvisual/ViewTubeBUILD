...
const evidence = {
 ...
 resolvedBundleFingerprint: "bundle-a",
 ...
 reportEvidencePack: {
  ...
  privacyFingerprint: "privacy-a",
  datasets: Array.from({ length: 34 }, (_, index) => ({ id: `dataset-${index}`, datasetVersion: `v-${index}`, status: "unavailable", rowCount: 0, sources: [], updatedAt: "2026-08-24T12:00:00.000Z", missingMetrics: [] })),
  facts: [],
  sectionFactIds: {},
  evidenceIndex: {
   "agg:views": { id: "agg:views", datasetId: "videos", datasetVersion: "v-videos", kind: "aggregate", label: "Views", value: 100, sourceEvidenceIds: [], sources: ["youtube_analytics_v2"], window: "28d", capturedAt: "2026-08-24T12:00:00.000Z", formula: "sum(views)" },
  },
  contradictions: [],
  missingInputs: [],
 },
...
const report = {
 ...
 claims: [{ id: "claim-a", statement: "The channel has 100 views.", classification: "fact", evidenceIds: ["agg:views"], confidence: 1, validationStatus: "valid" }],
 validation: { valid: true, repaired: false, errors: [], invalidClaimIds: [], unsupportedNumbers: [] },
 blocks: [],
 actionPlan: [],
 riskFlags: [],
