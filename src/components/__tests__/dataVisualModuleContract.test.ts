...
import { DATA_VISUAL_MODULE_CONTRACTS, dataVisualModuleContract, isRegisteredDataVisualModuleId } from "../dataVisualModuleContract"
...
describe("Data Visual module canvas contracts", () => {
 ...
 it("uses a wide outer canvas with a square internal plot for Publish Optimal Clock", () => {
  expect(dataVisualModuleContract("publish-optimal-clock")).toMatchObject({ family: "radial", canvasAspect: "16:9", plotAspect: "1:1", overflow: "clip" })
 })
