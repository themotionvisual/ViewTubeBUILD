  ...
  const engagementMapChart: ChartConfig = useMemo(
    () => ({
      ...
      options: {
        ...
        series: {
          0: { targetAxisIndex: 0, color: '#00CCFF' },
          1: { targetAxisIndex: 0, color: '#CCFF00' },
          2: { targetAxisIndex: 0, color: '#FFDD00' },
          3: { targetAxisIndex: 1, color: '#FF7497' },
        },
        lineWidth: 3,
        pointsVisible: false,
        legend: { position: 'none' },
    ...
    [engagementMapData, engagementSortBy],
  );
