...
const DASHBOARD_WIDGET_BASE_REGISTRY: WidgetDefinitionBase[] = [
  ...
  },
 {
  ...
  subtitle: "AI-favored thumbnail variant comparison",
  category: "creation",
  defaultSize: "half",
  minSize: "quarter",
  maxSize: "full",
  ...
  minHeight: "short",
  maxHeight: "xtall",
  ...getDashboardWidgetPaletteColors(46),
  dependency: ["youtube_data_v3", "gemini_api"],
  status: "ready",
 },
 {
  ...
  subtitle: "Channel pace against the algorithm curve",
  category: "analytics",
  defaultSize: "quarter",
  minSize: "quarter",
  maxSize: "half",
  ...
  minHeight: "short",
  maxHeight: "tall",
  ...getDashboardWidgetPaletteColors(47),
  dependency: ["youtube_analytics_v2"],
  status: "ready",
 },
 {
  id: "cpm-geo",
  title: "CPM by Geography",
  subtitle: "Top-earning territories by CPM",
  category: "analytics",
  defaultSize: "quarter",
  minSize: "quarter",
  maxSize: "half",
  ...
  minHeight: "short",
  maxHeight: "medium",
  ...getDashboardWidgetPaletteColors(48),
  dependency: ["youtube_analytics_v2"],
  status: "ready",
 },
 {
  id: "device-matrix",
  title: "Device Matrix",
  subtitle: "Mobile versus desktop viewing split",
  category: "analytics",
  defaultSize: "quarter",
  minSize: "quarter",
  maxSize: "half",
  ...
  minHeight: "short",
  maxHeight: "tall",
  ...getDashboardWidgetPaletteColors(49),
  dependency: ["youtube_analytics_v2"],
  status: "ready",
 },
 {
  id: "guest-ratio",
  title: "Guest Ratio",
  subtitle: "Subscriber-to-guest viewer ratio",
  category: "analytics",
  defaultSize: "quarter",
  minSize: "quarter",
  maxSize: "half",
  ...
  minHeight: "short",
  maxHeight: "medium",
  ...getDashboardWidgetPaletteColors(50),
  dependency: ["youtube_analytics_v2"],
  status: "ready",
 },
 {
  id: "playback-origins",
  title: "Playback Origins",
  subtitle: "Search, browse and suggested traffic origins",
  category: "analytics",
  defaultSize: "half",
  minSize: "quarter",
  maxSize: "full",
  ...
  minHeight: "short",
  maxHeight: "tall",
  ...getDashboardWidgetPaletteColors(51),
  dependency: ["youtube_analytics_v2"],
  status: "ready",
 },
 {
  id: "premium-pulse",
  title: "Premium Pulse",
  subtitle: "YouTube Premium engagement and member signal",
  category: "analytics",
  defaultSize: "quarter",
  minSize: "quarter",
  maxSize: "half",
  ...
  minHeight: "short",
  maxHeight: "tall",
  ...getDashboardWidgetPaletteColors(52),
  dependency: ["youtube_analytics_v2"],
  status: "ready",
 },
 {
  id: "sharing-dna",
  title: "Sharing DNA",
  subtitle: "Where viewers share your videos",
  category: "analytics",
  defaultSize: "quarter",
  minSize: "quarter",
  maxSize: "half",
  ...
  minHeight: "short",
  maxHeight: "tall",
  ...getDashboardWidgetPaletteColors(53),
  dependency: ["youtube_analytics_v2"],
  status: "ready",
 },
 {
  id: "video-comment-operator",
  title: "Video Comment Operator",
  subtitle: "Per-video comment operations console",
  category: "community",
  defaultSize: "half",
  minSize: "third",
  maxSize: "full",
  ...
  minHeight: "medium",
  maxHeight: "massive",
  ...getDashboardWidgetPaletteColors(54),
  dependency: ["youtube_data_v3"],
  status: "ready",
 },
]
