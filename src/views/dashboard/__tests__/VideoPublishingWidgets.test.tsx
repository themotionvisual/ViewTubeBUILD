...
describe("split video publishing widgets", () => {
 ...
 it("builds the uploader around its independent upload gantry", async () => {
  ...
  expect(container.querySelector(".video-uploader-footer .widget-split-button")?.className).toContain("is-left-split")
  expect(container.querySelector(".video-uploader-footer .widget-split-button")?.className).toContain("is-height-38")
