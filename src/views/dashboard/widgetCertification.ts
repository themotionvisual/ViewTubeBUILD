...
const CERTIFICATION_INTENT: Record<string, readonly [string, string, WidgetPerformanceCost]> = {
  "app-verification-explainer": ["Hook first-time visitors with the ViewTube spectrum, creator loop, tools, and trust path", "Open a system destination or account/data guidance", "light"],
