...
import { ToolboxScaffold } from '../components/ToolboxScaffold';
...
const StoryboardStudio: React.FC<StoryboardStudioProps> = ({ embedded = false }) => {
  ...
  const [scenes, setScenes] = useState<Scene[]>([
    ...
    },
    {
      ...
      broll: 'Slow pan across a cluttered digital workspace, transitioning to clear, vibrant UI overlays.',
      imageUrl: null,
      emotionScore: 40,
      durationEstimate: 12
    }
  ...
  return (
    <ToolboxScaffold
      ...
      embedded={embedded}
      outerClassName="max-w-[1400px] mx-auto pb-40 animate-fade-in px-4"
                    ...
                    <div key={scene.id} className="bg-white border-[3px] border-black rounded-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,0.1)] flex flex-col overflow-hidden transform hover:-translate-y-1 transition-transform">
                      ...
                      <div className="bg-black p-0 group cursor-pointer overflow-hidden border-b-[3px] border-black relative">
                        ...
                        <div className="aspect-video bg-gray-900 border-y-2 border-white/10 flex items-center justify-center relative overflow-hidden group-hover:bg-gray-800 transition-colors">
                          {scene.imageUrl ? (
                            <img src={scene.imageUrl} alt="Scene Visual" className="w-full h-full object-cover opacity-80 group-hover:opacity-100 transition-opacity" />
                          ) : (
                            <div className="flex flex-col items-center text-white/20 group-hover:text-white transition-colors">
                              <ImageIcon size={32} />
                              <span className="text-[10px] font-black mt-2 uppercase tracking-[0.2em]">Frame Ready</span>
                            </div>
                          )}
            ...
            <div className="w-[25%] bg-white border-[3px] border-black rounded-xl shadow-[6px_6px_0px_0px_black] flex flex-col overflow-hidden">
              ...
              <div className="flex-1 overflow-y-auto flex flex-col bg-gray-50">
                ...
                <div className="p-4 border-b-[3px] border-black bg-white">
                  <h3 className="font-black mb-3 flex items-center gap-2 uppercase text-sm"><Activity size={16} className="text-[#ff3399]" /> Emotion Arc</h3>
                ...
                <div className="p-4 flex-1">
                  <h3 className="font-black text-black mb-3 flex items-center gap-2 text-sm uppercase"><AlertTriangle size={16} className={warnings.length > 0 ? "text-red-500" : "text-black"} /> Retentions Flags</h3>
                  {warnings.length === 0 ? (
