...
export const SUPER_TOOL_RUNTIME_PLAN_RECORDS: Record<SuperToolId, SuperToolRuntimePlanRecord> = {
 "creator-canvas-os": {
  ...
  currentRouteReality: "/tools/creator-canvas-os",
 ...
 "audience-loop-studio": {
  ...
  buildState: "prototype_available",
  agentGroup: "studio_projects",
  currentRouteReality: "/tools/audience-loop-studio",
 ...
 "packaging-lab-pro": {
  ...
  buildState: "prototype_available",
  agentGroup: "studio_projects",
  currentRouteReality: "/packaging-lab-pro",
  runtimeBoundary: "Reachable top-level route; hands packaging experiments to retention and analytics through the shared generation/workflow stores without duplicate state.",
 ...
 "project-command-kanban": {
  ...
  buildState: "prototype_available",
  agentGroup: "studio_projects",
  currentRouteReality: "/tools/project-command-kanban",
 ...
 "series-and-theme-generator": {
  ...
  buildState: "prototype_available",
  agentGroup: "studio_projects",
  currentRouteReality: "/tools/series-and-theme-generator",
 ...
 "publishing-schedule-architect": {
  ...
  buildState: "prototype_available",
  agentGroup: "studio_projects",
  currentRouteReality: "/tools/publishing-schedule-architect",
 ...
 "shorts-extraction-studio": {
  ...
  currentRouteReality: "/tools/shorts-extraction-studio",
 ...
 "cinematic-analytics-lab": {
  ...
  buildState: "prototype_available",
  agentGroup: "analytics_shorts",
  currentRouteReality: "/tools/cinematic-analytics-lab",
 ...
 "retention-autopsy-experiment-engine": {
  ...
  buildState: "prototype_available",
  agentGroup: "analytics_shorts",
  currentRouteReality: "/tools/retention-autopsy-experiment-engine",
 ...
 "brain-command-center": {
  ...
  currentRouteReality: "/tools/brain-command-center",
  runtimeBoundary:
 ...
 "workflow-chain-builder": {
  ...
  buildState: "prototype_available",
  agentGroup: "brain_workflow",
  currentRouteReality: "/tools/workflow-chain-builder",
