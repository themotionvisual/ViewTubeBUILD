...
/**
 * Task-scoped durable knowledge reader for BrainRuntime.
 *
 * Persistence remains owned by ChannelProfileAdapter and the existing Brain
 * stores; callers receive a bounded projection rather than raw store access.
 */
