...
export const CREATOR_QUESTION_SUITE: BrainGoldenScenario[] = [
 ...
 { id: "rest-subs", fixtureId: "restoration-rich", family: "subscribers", question: "How do I turn more viewers into subscribers?", expectedIntent: "strategy_brief", requiredEvidenceTypes: ["top_videos"], mayAskQuestion: false, mayOfferHandoff: false },
 ...
 { id: "rest-audience", fixtureId: "restoration-rich", family: "audience_request", question: "What audience request keeps coming up for me?", expectedIntent: "strategy_brief", requiredEvidenceTypes: ["clusters"], mayAskQuestion: true, mayOfferHandoff: false },
