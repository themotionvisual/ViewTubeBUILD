...
describe("BrainTaskProfileRegistry", () => {
 const routingTable = [
  ...
  ["What worked from the recommendations we tried?", "evaluation"],
  ["Which recommendation failed?", "evaluation"],
  ["What still needs evidence?", "evaluation"],
  ["How reliable are your high confidence recommendations?", "evaluation"],
  ["What should I stop doing based on measured outcomes?", "evaluation"],
