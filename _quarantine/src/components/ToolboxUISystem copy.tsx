       ...
       <div
        ...
        {options.map((option) => (
         <button
          ...
          style={{
           backgroundColor:
            hoveredOption === option ? resolvedSurfaceColor : idleOptionColor,
          }}
...
const ActionControlButton: React.FC<ActionControlButtonProps> = ({
 ...
 return (
  <button
   ...
   <IconRail backgroundColor={resolvedControlColor}>{icon}</IconRail>
   <div
...
const ToolboxUISystem: React.FC<ToolboxUISystemProps> = ({ mode = "full" }) => {
 ...
 const [isSubtoolboxesGalleryOpen, setIsSubtoolboxesGalleryOpen] =
  useState(true)
  ...
  <div className="w-full max-w-[1400px] mx-auto mb-40 space-y-12">
            ...
            <div
             ...
             <div className="w-16 h-16 border-[3px] border-black rounded-full bg-white flex items-center justify-center">
              <Zap
               ...
               style={{ color: studioRow0Pair.header }}
              />
             </div>
   ...
   {showSubtoolboxesGallery && (
    <div
     ...
     <div
      className={`grid transition-[grid-template-rows] duration-[600ms] ease-[cubic-bezier(0.4,0,0.2,1)] ${isSubtoolboxesGalleryOpen ? "grid-rows-[1fr]" : "grid-rows-[0fr]"}`}
      style={{ marginTop: `-${CONFIG.scaffoldStroke}px` }}>
      <div className="overflow-hidden min-h-0">
       <main
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
         ...
         <SubToolbox
          ...
          <div className="flex flex-col gap-4 p-4">
            ...
            <StandardDropdown options={[{ label: "Option 1", value: "opt1" }, { label: "Option 2", value: "opt2" }]} onChange={() => {}} />
         ...
         <SubToolbox
          ...
          headerBg="#FFE357"
          iconBg="#FF7497"
          isOpen={isGalOverviewOpen}
          onToggle={() => setIsGalOverviewOpen((p) => !p)}
          openUnits={4}
          config={CONFIG}>
           ...
           {isGalOverviewOpen && (
            <>
             ...
             <MetricCard
              ...
              value="1.2K hrs"
              change="+8.3%"
              sparklineData={[20, 35, 45, 40, 55, 65, 60, 75]}
              color="#C9F830"
             />
             <MetricCard
              title="Engagement"
              ...
              change="-2.1%"
              changeType="negative"
              sparklineData={[90, 85, 88, 82, 87, 89, 84, 89]}
              color="#FF7497"
             />
             <MetricCard
              title="Sub"
              value="142K"
              change="+5.7%"
              sparklineData={[100, 110, 108, 120, 125, 130, 135, 142]}
              color="#FFE357"
             />
            </>
           )}
         ...
         <SubToolbox
          ...
          headerBg="#C9F830"
          iconBg="#00D2FF"
          isOpen={isGalTrendsOpen}
          onToggle={() => setIsGalTrendsOpen((p) => !p)}
          openUnits={4}
          config={CONFIG}>
         ...
         headerBg="#FF7497"
         iconBg="#FFE357"
         isOpen={isGalEngagementOpen}
         onToggle={() => setIsGalEngagementOpen((p) => !p)}
         openUnits={4}
         config={CONFIG}>
         <div className="grid grid-cols-2 gap-4 h-[180px]">
          ...
          <MiniModule title="Activity" headerColor="bg-[#FF7497]">
           <div className="h-full flex items-center justify-center relative translate-y-1">
            <ActivityRings
             rings={[
              { value: 78, max: 100, color: "#FF7497", label: "Likes" },
              { value: 62, max: 100, color: "#C9F830", label: "Comments" },
              { value: 45, max: 100, color: "#00D2FF", label: "Shares" },
             ]}
             size={110}
            />
           </div>
         ...
         <SubToolbox
          ...
          <div className="flex flex-col gap-6 p-4 overflow-y-auto">
            ...
            <div className="flex flex-wrap gap-2">
             {[
               "#FF3399", "#CCFF00", "#00CCFF", "#FFDD00", "#FFB158", "#00D2FF", 
               "#FFE357", "#FF7497", "#FF83EA", "#FF8AAF", "#FFB570", "#FFFF61", 
               "#4FFF5B", "#40C6E9", "#579AFF", "#CC00FF", "#00FF99", "#888888"
             ].map((color) => (
              <button
               key={color}
               onMouseDown={(e) => {
         ...
         <SubToolbox
          ...
          headerBg="#24D3FF"
          iconBg="#FFE357"
          isOpen={isGalConceptOpen}
          onToggle={() => setIsGalConceptOpen((prev) => !prev)}
          openUnits={4}
          config={CONFIG}>
          <div className="flex flex-col h-full justify-between gap-4">
           <textarea
            placeholder="Describe your content idea..."
            className="w-full flex-1 p-4 text-sm font-bold rounded-2xl outline-none resize-none border-[4px] bg-white border-black text-black placeholder:text-black/20"
           />
           <div className="flex justify-between items-center gap-4">
            {/* <KeyboardShortcut keys={["Ctrl", "Enter"]} /> */}
            <span className="font-mono text-xs font-bold px-2 border-2 border-black rounded shadow-[2px_2px_0px_0px_black] bg-white">
             CTRL + ENTER
            </span>
            <ActionControlButton
             label="Auto-Refine"
         ...
         <SubToolbox
          ...
          headerBg="#C9F830"
          iconBg="#24D3FF"
          isOpen={isGalStylesOpen}
          onToggle={() => setIsGalStylesOpen((p) => !p)}
          openUnits={4}
          config={CONFIG}>
          <div className="grid grid-cols-3 gap-2 h-full">
           {STYLES.slice(0, 9).map((style) => (
            <button
             key={style}
             className="h-full rounded-xl font-black uppercase text-[9px] transition-all border-[3px] border-black bg-white text-black hover:bg-black hover:text-white min-h-[40px]">
             {style}
            </button>
           ))}
          </div>
         ...
         <SubToolbox
          ...
          headerBg="#FFE357"
          iconBg="#C9F830"
          isOpen={isGalTextOpen}
          onToggle={() => setIsGalTextOpen((p) => !p)}
          openUnits={3}
          config={CONFIG}>
         ...
         <SubToolbox
          ...
          headerBg="#FCAF57"
          iconBg="#FFE357"
          isOpen={isGalTagsOpen}
          onToggle={() => setIsGalTagsOpen((p) => !p)}
          openUnits={3}
          config={CONFIG}>
         ...
         <SubToolbox
          ...
          headerBg="#00D2FF"
          iconBg="#C9F830"
          isOpen={isGalResourcesOpen}
          onToggle={() => setIsGalResourcesOpen((p) => !p)}
          openUnits={5}
          config={CONFIG}>
         ...
         <SubToolbox
          ...
          headerBg="#FF7497"
          iconBg="#FFE357"
          isOpen={isGalSecurityOpen}
          onToggle={() => setIsGalSecurityOpen((p) => !p)}
          openUnits={4}
          config={CONFIG}>
          <div className="flex flex-col gap-4 h-full justify-between">
           <div>
            <label className="text-[10px] font-black uppercase tracking-widest mb-2 block text-black/60">
             Admin Password
            </label>
         ...
         <SubToolbox
          ...
          headerBg="#FCAF57"
          iconBg="#C9F830"
          isOpen={isGalNetworkOpen}
          onToggle={() => setIsGalNetworkOpen((p) => !p)}
          openUnits={3}
          config={CONFIG}>
          <div className="flex flex-col gap-5 h-full justify-center">
           <div className="flex items-center justify-between">
            ...
            <TripleStateSwitch
             state={galNetworkState}
             onChange={setGalNetworkState}
             labels={["Off", "Auto", "On"]}
             colors={["#FF3399", "#FFE357", "#C9F830"]}
            />
           </div>
           <div className="flex items-center justify-between">
            <span className="font-bold uppercase text-sm text-black">
         ...
         <SubToolbox
          ...
          headerBg="#24D3FF"
          iconBg="#FFE357"
          isOpen={isGalStorageOpen}
          onToggle={() => setIsGalStorageOpen((p) => !p)}
          openUnits={3}
          config={CONFIG}>
          <div className="flex flex-col gap-5 h-full justify-center">
           <LinearGauge
           ...
           <div className="flex gap-2">
            <button className="flex-1 py-3 border-[3px] rounded-xl font-[900] uppercase text-xs flex items-center justify-center gap-2 transition-all hover:scale-[1.02] border-black bg-[#C9F830]">
             <Download size={14} />
             Backup
            </button>
            <button className="flex-1 py-3 border-[3px] rounded-xl font-[900] uppercase text-xs flex items-center justify-center gap-2 transition-all hover:scale-[1.02] border-black bg-[#FFE357]">
             <Upload size={14} />
             Restore
            </button>
            <button className="py-3 px-4 border-[3px] rounded-xl font-[900] uppercase text-xs flex items-center justify-center transition-all hover:scale-[1.02] border-black bg-[#FF3399] text-white">
             <Trash2 size={14} />
            </button>
           </div>
          </div>
         ...
         <SubToolbox
          ...
          <div className="grid grid-cols-3 gap-3">
           {[
            ...
            <div
             key={stat.label}
             className="border-[3px] border-black rounded-xl bg-white overflow-hidden">
             <div
              className="h-7 border-b-[3px] border-black text-[10px] font-black uppercase flex items-center justify-center"
              style={{ backgroundColor: stat.bg }}>
              {stat.label}
             </div>
             <div className="h-12 flex items-center justify-center text-[20px] font-[1000]">
              {stat.value}
             </div>
            </div>
           ))}
  ...
  <div
   ...
   <ResponsiveContainer width="100%" height="100%" minWidth={1} minHeight={1}>
    <AreaChart data={data}>
     ...
     <XAxis
      dataKey="name"
      stroke={variant === "standard" ? "#000" : "#FFF"}
      strokeWidth={2}
     ...
     <Tooltip
      contentStyle={{
       ...
       border: `3px solid ${variant === "tokyo-pop" ? "#FF00FF" : "black"}`,
       borderRadius: "12px",
       fontWeight: 900,
      }}
     />
...
export function BrutalistBarChart({
 data,
 dataKey,
 colors = ["#FF7497", "#C9F830", "#00D2FF", "#FFE357", "#FF3399"],
 height = 200,
 variant = "standard",
}: any) {
 return (
  <div
   ...
   <ResponsiveContainer width="100%" height="100%" minWidth={1} minHeight={1}>
    <BarChart data={data}>
     ...
     <Tooltip
      contentStyle={{
       backgroundColor: variant === "standard" ? "#FFF" : "#000",
       border: `3px solid ${variant === "tokyo-pop" ? "#FF00FF" : "black"}`,
       borderRadius: "12px",
       fontWeight: 900,
      }}
     ...
     <Bar dataKey={dataKey} radius={[8, 8, 0, 0]}>
      {data.map((_: any, index: number) => (
       <Cell
        key={`cell-${index}`}
        fill={
         variant === "tokyo-pop" ? "#00FFFF" : colors[index % colors.length]
        }
        stroke={variant === "tokyo-pop" ? "#FF00FF" : "black"}
        strokeWidth={3}
       />
      ))}
     </Bar>
 ...
 return (
  <div className="flex flex-col items-center">
   <div className="relative" style={{ width: size, height: size }}>
    ...
    <div
     className={`absolute inset-0 flex items-center justify-center ${styles.text}`}>
     <span className="text-2xl font-[1000]">{Math.round(percentage)}%</span>
    </div>
   </div>
   {label && (
    <span
     className={`text-[10px] font-black uppercase tracking-widest mt-2 ${styles.text}`}>
     {label}
    </span>
   )}
  </div>
  ...
  <div className="w-full">
   {label && (
    <div className="flex justify-between items-center mb-2">
     <span
      className={`text-[10px] font-black uppercase tracking-widest ${styles.text}/60`}>
      {label}
     </span>
     <span className={`text-[12px] font-[1000] ${styles.text}`}>
      {value}/{max}
     </span>
    </div>
   )}
   <div
    className={`relative h-6 ${styles.bg} border-[3px] ${styles.border} rounded-full overflow-hidden`}>
    <div
     className="absolute top-0 left-0 h-full rounded-full transition-all duration-700 ease-out"
     style={{
      width: `${percentage}%`,
      backgroundColor: variant === "tokyo-pop" ? "#00FFFF" : color,
      boxShadow: variant === "tokyo-pop" ? "0 0 15px #00FFFF" : undefined,
     }}
    />
   </div>
  </div>
      ...
      return (
       <g key={ring.label}>
        <circle
         ...
         r={radius}
         fill="none"
         stroke={variant === "standard" ? "#00000010" : "#FFFFFF10"}
         strokeWidth={strokeWidth}
        />
        <circle
         cx={size / 2}
         ...
         r={radius}
         fill="none"
         stroke={variant === "tokyo-pop" ? "#00FFFF" : ring.color}
         strokeWidth={strokeWidth}
         strokeDasharray={circumference}
         strokeDashoffset={offset}
         strokeLinecap="round"
    ...
    {rings.map((ring: any) => (
     <div key={ring.label} className="flex items-center gap-1">
      <div
       ...
       style={{
        backgroundColor: variant === "tokyo-pop" ? "#00FFFF" : ring.color,
       }}
      />
      <span
       className={`text-[9px] font-black uppercase ${variant === "standard" ? "text-black" : "text-white"}`}>
       {ring.label}
      </span>
     </div>
    ))}
...
export function MetricCard({
 ...
 return (
  <div
   className={`${styles.border} border-[4px] rounded-2xl ${styles.bg} p-4 shadow-[4px_4px_0px_0px_black]`}>
   <div className="flex justify-between items-start mb-2">
    <span
     className={`text-[10px] font-black uppercase tracking-widest ${styles.subtext}`}>
     {title}
    </span>
    {change && (
     <span className={`text-[10px] font-black ${changeColors[changeType]}`}>
      {change}
     </span>
    )}
   </div>
 ...
 return (
  <div className="flex flex-col items-center">
   <div className="relative h-8 w-24 bg-gray-100 border-[3px] border-black rounded-full overflow-hidden">
    <div
     className="absolute top-0 left-0 h-full w-1/3 transition-all duration-300"
     style={{
    ...
    <div className="absolute inset-0 flex">
     {[0, 1, 2].map((i) => (
      <button
       key={i}
       onClick={() => onChange(i as any)}
       className="flex-1 flex items-center justify-center">
       {state === i && (
        <div className="w-4 h-4 bg-white border-[2px] border-black rounded-full shadow-[1px_1px_0px_0px_black]" />
       )}
      </button>
     ))}
    </div>
...
export function TokyoPopSwitch({ checked, onChange, label }: any) {
 return (
  <label className="flex items-center gap-3 cursor-pointer">
   <button
    onClick={() => onChange(!checked)}
    className="relative w-14 h-7 rounded-full border-[3px] transition-all"
    style={{
     borderColor: "#FF00FF",
     backgroundColor: checked ? "#FF00FF" : "black",
     boxShadow: checked ? "0 0 20px #FF00FF, 0 0 40px #FF00FF40" : "none",
    }}>
    <div
   ...
   {label && (
    <span
     className="text-sm font-bold uppercase text-[#00FFFF]"
 ...
 return (
  <div className="relative">
   <input
    ...
    className={`w-full h-14 px-4 pr-14 text-sm font-bold ${styles.border} border-[4px] rounded-2xl ${styles.bg} ${styles.text} ${styles.placeholder} outline-none focus:ring-4 focus:ring-[#C9F830] transition-all shadow-[3px_3px_0px_0px_black]`}
   />
   <button
    type="button"
...
export function Keycap({ children, size = "md", variant = "standard" }: any) {
 const sizes: any = {
  sm: "min-w-[28px] h-7 text-[10px] px-2",
  md: "min-w-[36px] h-9 text-xs px-3",
 ...
 return (
  <div className="flex flex-wrap gap-2 p-3 min-h-[56px] border-[4px] border-black rounded-2xl bg-white">
   {tags.map((tag: string) => (
    <span
     key={tag}
     className="inline-flex items-center gap-1 px-3 py-1 text-xs font-[900] uppercase border-[3px] border-black rounded-full shadow-[2px_2px_0px_0px_black]"
     style={{ backgroundColor: color }}>
     {tag}
     <button
      onClick={() => onChange(tags.filter((t: string) => t !== tag))}
      className="w-4 h-4 flex items-center justify-center rounded-full bg-black text-white hover:bg-red-500 transition-colors">
   ...
   <input
    ...
    className="flex-1 min-w-[100px] h-8 text-sm font-bold outline-none bg-transparent placeholder:text-black/30"
   />
  </div>
 )
}
...
export function MiniModule({
 ...
 return (
  <section
   ...
   <div
    className={`h-10 ${headerColor} border-b-[3px] ${styles.border} flex items-center px-4 shrink-0`}>
    <h3
     className={`text-sm font-[1000] uppercase tracking-tighter mt-0.5 ${styles.text}`}>
     {title}
    </h3>
   </div>
 ...
 return (
  <div className="flex flex-col justify-center h-[40px]">
   <div className="flex justify-between items-end mb-1">
    <span
     className={`text-[9px] font-black uppercase tracking-widest ${styles.labelColor} leading-none`}>
     {label}
    </span>
    <span
     className={`text-[10px] font-[1000] leading-none ${styles.valueColor}`}>
     {value}%
    </span>
   </div>
   <div
    className={`w-full h-4 ${styles.trackBg} border-[3px] ${styles.border} rounded-full overflow-hidden`}>
    <div
