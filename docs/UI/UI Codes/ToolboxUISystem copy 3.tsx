...
// ============================================================================
// Video Analytics Data Types
// ============================================================================

/** Represents analytics data for a single video */
export type VideoAnalyticsData = {
 /** Unique identifier for the video */
 id: string | number
 /** Short title for display in charts */
 title: string
 /** Number of likes */
 likes: number
 /** Number of comments */
...
export type AnalyticsDataProps = {
 /** Array of video analytics data. If not provided, shows empty/loading state */
...
type ToolboxUISystemProps = {
 ...
 /** Array of video analytics data for charts. If not provided, charts will show empty state */
 videoData?: VideoAnalyticsData[]
}

const ToolboxUISystem: React.FC<ToolboxUISystemProps> = ({ mode = "full", videoData = [] }) => {
 // Toolbox state
 ...
 // Map videoData to the format expected by charts (with shortTitle from title)
 ...
 }, [mappedVideoData, engagementSortMetric, engagementSortDir])
 ...
 return (
  ...
  {/* TEMPORARILY DISABLED: showPackScaffold & showComponentGrid
  {showPackScaffold && (
    <div
     className="w-full bg-white flex flex-col overflow-hidden relative shadow-[12px_12px_0px_0px_rgba(0,0,0,0.5)] transition-all"
     style={{
