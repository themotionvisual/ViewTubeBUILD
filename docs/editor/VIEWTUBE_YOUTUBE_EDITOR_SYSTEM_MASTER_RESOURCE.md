...
**Last audited main commit:** 4a273685fcae36403977e28be9804b02217717c4  
...
| Mobile/desktop capability parity | started | editor state + UI | round-trip fixtures + capability matrix | verified existing registry; finish evidence-backed surface matrix |
| Shared FX/transition catalogs | partial | editor core | same IDs and rendering on both surfaces | transition catalog complete; shared renderer-backed FX catalog implemented; verify desktop surface parity next |
| Preview ↔ final Remotion parity | started | editor + remotion | frame fixtures pass | transitions share frame math; FX now shares filter/opacity evaluator; expand to transforms/crop/keyframes/assets/audio |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2026-09-24 | ChatGPT Phase A FX contract pass | feat/editor-phase-a-fx-contract-2026-09-24 | started | Added canonical renderer-backed FX catalog and shared evaluator; rewired mobile FX rack, mobile preview, and final Remotion composition to the same contract; promoted color/blur from planned to available; retained motion blur/mask as planned. | src/shared/vtE1FxCatalog.*; EffectsLibrariesPanel.tsx; MobileProjectPreview.tsx; Composition.tsx; editorCapabilities.ts; EditorControlManifest.tsx | source audit verified the same payload fields already render in mobile preview + final Remotion; dedicated contract tests added; CI pending | Phase A parity audit | run gates; then add rich whole-project round-trip fixture and broader preview/final fixtures |
