# 📊 THE DEFINITIVE YOUTUBE METRICS ENCYCLOPEDIA

Exhaustive categorized reference of every YouTube statistic, dimension, and metric organized by scope: Channel-Wide, Individual Video (All Formats), Long-Form Only, and Shorts Only. Each entry includes the common creator nickname, precise formatted title as it appears in YouTube Studio/CSV exports, the exact Analytics API camelCase name, the Reporting API snake_case CSV name, a detailed description explaining what the stat measures, how it differs from similar stats, and practical notes. Covers 8 categories: View & Reach, Watch Time & Retention, Engagement & Interaction, Monetization & Ads, Audience & Demographics, Geography, Traffic Sources, and Device & Playback Context. Also includes dimension breakdowns for geographic, demographic, traffic, and content-type segmentation.
...
:::sub 1.1 Channel Profile & Identity (Data API v3)
...
:::sub 1.2 Channel-Level Audience Metrics (Analytics API — No Video Filter)
...
:::sub 1.3 Channel-Level Demographics (Analytics API)
...
:::sub 2.3 Engagement & Interaction
| Common Name | Formatted Title | Analytics API | CSV Name | Core | Description |
|---|---|---|---|---|---|
...
:::sub 2.5 Traffic Sources (Dimension Breakdown)
...
:::sub 2.6 Geography (Dimension Breakdown)
...
:::sub 2.7 Device & Playback Context (Dimension Breakdown)
| Common Name | Formatted Title | Analytics API Dimension | CSV Dimension | Description |
|---|---|---|---|---|
...
:::sub 2.8 Content Format Dimension
| Common Name | Formatted Title | Analytics API Dimension | CSV Dimension | Description |
|---|---|---|---|---|
...
:::sub 3.1 Retention Curves (Long-Form Exclusive)
...
:::sub 3.2 Card & End Screen Metrics (Long-Form Features)
...
:::sub 3.3 Long-Form Monetization Details
...
:::sub 3.4 Long-Form Premium Metrics
| Common Name | Formatted Title | Analytics API | CSV Name | Description |
|---|---|---|---|---|
...
:::sub 4.1 Shorts-Specific View Mechanics
...
:::sub 4.2 Shorts Discovery & Traffic
| Source | Description |
|---|---|
...
:::sub 4.3 Shorts Monetization Model
| Aspect | Description |
|---|---|
...
:::sub 4.4 Shorts-Specific Features Not Available via API
| Feature | Notes |
|---|---|
